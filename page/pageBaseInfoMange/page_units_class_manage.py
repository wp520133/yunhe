...
class PageUnitsClassManage(Base):
    ...
    # 输入部件类别名称
    def page_units_class_manage_insert_units_class_name_input(self):
        self.base_input(page.public_name_input, page.public_value)

    # 输入描述
    def page_units_class_manage_insert_units_class_desc_input(self):
    ...
    # 新增
    def units_class_manage_insert(self):
        ...
        self.page_units_class_manage_insert_units_class_name_input()
        self.page_units_class_manage_insert_units_class_desc_input()
    ...
    # 编辑
    def units_class_manage_edit(self):
        self.units_class_manage_insert()
