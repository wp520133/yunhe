...
class PageRepairClassManage(Base):
    ...
    # 输入备件类别名称
    def page_repair_class_manage_repair_class_name_input(self):
        self.base_input(page.public_name_input, page.public_value)

    # 输入描述
    def page_repair_class_manage_desc_input(self):
    ...
    def repair_class_manage_insert(self):
        ...
        self.page_repair_class_manage_repair_class_name_input()
        self.page_repair_class_manage_desc_input()
    ...
    # 编辑
    def repair_class_manage_edit(self):
        self.repair_class_manage_insert()
