...
class TestNumDictManage(unittest.TestCase):
    ...
    def test_num_dict_manage_except_insert(self, desc, type_other, mark_info, success):
    ...
    def test_num_dict_manage_edit(self):
        self.pndm.page_num_dict_manage_edit(page.public_value, page.public_value, page.public_value)

    # 测试数字字典字典项新增
    @parameterized.expand(read_txt("system_manage/system_num_dict_tem.txt"))
    @allure.step(title="测试数字字典项的异常输入新增")
    # @pytest.mark.run(order=4)
    def test_num_dict_manage_four_line_nape_insert(self, data, tag, desc, order, mark_info, success):
    ...
    def test_num_dict_manage_four_line_nape_edit(self):
        self.pndm.page_num_dict_manage_four_line_nape_edit(page.public_value, page.public_value, page.public_value,
                                                           page.public_order_num, page.public_value)
